...
const ResidentCard = ({ url }) => {
    ...
    const [character, getCharater] = useFetch(url)
        ...
        <article className="resident">
            ...
            <section className="resident__body">
                ...
                <ul className="resident__list">
                    ...
                    <li className="resident__item"><span className="resident__label">Episode where appear</span><span className="resident__value">{character?.episode.length}</span></li>
                </ul>
            </section>
        </article>
    )
